(function () {
  ...
  function injectCSS() {
    ...
    style.id = "the-board-widget-style";
      var css = [
        ".tb-launcher { position: fixed; top: 50%; right: -2.5rem; transform: translateY(-50%) rotate(-90deg); display: inline-flex; align-items: center; gap: 0.6rem; padding: 0.65rem 1.2rem; border-radius: 999px; font-size: 0.95rem; font-weight: 600; color: #172d37; background: linear-gradient(135deg, #f3c969, #dba53c); border: none; box-shadow: 0 12px 28px rgba(243, 201, 105, 0.35); cursor: pointer; z-index: 2147483640; transition: all 0.2s ease; font-family: inherit; }",
        ...
        ".tb-modal { position: relative; width: min(900px, 95vw); max-height: 85vh; background: #0f2731; border-radius: 20px; box-shadow: 0 24px 48px -24px rgba(0, 0, 0, 0.75); overflow: hidden; display: flex; flex-direction: column; color: #fdf7e3; border: 1px solid rgba(243, 201, 105, 0.32); }",
        ...
        ".tb-auth-modal { position: relative; width: min(480px, 95vw); background: #0f2731; border-radius: 20px; box-shadow: 0 24px 48px -24px rgba(0, 0, 0, 0.75); overflow: hidden; display: flex; flex-direction: column; color: #fdf7e3; border: 1px solid rgba(243, 201, 105, 0.32); }",
        ...
        ".tb-detail-modal { position: relative; width: min(720px, 95vw); max-height: 85vh; background: #0f2731; border-radius: 20px; box-shadow: 0 24px 48px -24px rgba(0, 0, 0, 0.75); overflow: hidden; display: flex; flex-direction: column; color: #fdf7e3; border: 1px solid rgba(243, 201, 105, 0.32); }",
        ".tb-implemented-overlay { position: fixed; inset: 0; display: flex; align-items: center; justify-content: center; padding: 2rem; backdrop-filter: blur(4px); z-index: 2147483635; opacity: 0; visibility: hidden; pointer-events: none; transition: opacity 0.2s ease; background: rgba(5, 17, 24, 0.78); }",
        ".tb-implemented-overlay.tb-open { opacity: 1; visibility: visible; pointer-events: auto; }",
        ".tb-implemented-modal { position: relative; width: min(840px, 95vw); max-height: 85vh; border-radius: 20px; overflow: hidden; display: flex; flex-direction: column; background: #0f2731; color: #fdf7e3; border: 1px solid rgba(243, 201, 105, 0.32); box-shadow: 0 24px 48px -24px rgba(0, 0, 0, 0.75); }",
        ...
        ".tb-detail-footer { display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 1rem; padding: 1rem 2rem; border-top: 1px solid rgba(243, 201, 105, 0.28); background: rgba(12, 32, 41, 0.95); border-top-color: rgba(243, 201, 105, 0.28); }",
        ...
        ".tb-header { display: flex; align-items: center; justify-content: space-between; gap: 1rem; padding: 1.5rem 2rem; border-bottom: 2px solid rgba(243, 201, 105, 0.28); flex-shrink: 0; background: rgba(14, 38, 48, 0.95); border-color: rgba(243, 201, 105, 0.28); color: #fdf7e3; }",
        ...
        ".tb-body { display: flex; flex-direction: column; flex: 1; overflow: auto; background: #0d1f29; color: #fdf7e3; }",
        ".tb-body::-webkit-scrollbar { width: 8px; }",
        ".tb-body::-webkit-scrollbar-thumb { background: #143b47; border-radius: 4px; }",
        ".tb-auth-panel { flex: 0 0 auto; padding: 1.5rem 2rem; border-bottom: 1px solid rgba(243, 201, 105, 0.28); background: rgba(14, 38, 48, 0.95); border-color: rgba(243, 201, 105, 0.28); color: #fdf7e3; }",
        ".tb-submit-panel { flex: 0 0 auto; padding: 1.5rem 2rem; border-bottom: 1px solid rgba(243, 201, 105, 0.28); background: rgba(14, 38, 48, 0.95); border-color: rgba(243, 201, 105, 0.28); color: #fdf7e3; }",
        ".tb-button-group { display: flex; gap: 0.75rem; }",
        ".tb-btn-secondary { border-radius: 8px; padding: 0.5rem 1rem; font-size: 0.875rem; font-weight: 500; background: rgba(14, 49, 63, 0.7); color: #fdf7e3; border: 2px solid rgba(243, 201, 105, 0.26); cursor: pointer; transition: all 0.2s ease; min-height: 46px; border-color: rgba(243, 201, 105, 0.26); font-family: inherit; }",
        ...
        ".tb-controls { display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 1rem; padding: 1rem 2rem; border-bottom: 1px solid rgba(243, 201, 105, 0.28); background: rgba(14, 38, 48, 0.95); border-color: rgba(243, 201, 105, 0.28); color: #fdf7e3; }",
        ...
        ".tb-btn-primary { border-radius: 8px; padding: 0.5rem 1.5rem; font-size: 0.875rem; font-weight: 500; background: #f3c969; color: #0b161b; border: 2px solid #dba53c; cursor: pointer; transition: all 0.2s ease; min-height: 36px; border-color: #dba53c; font-family: inherit; }",
        ...
        ".tb-feature { display: flex; gap: 1rem; padding: 1.5rem 2rem; background: rgba(14, 40, 52, 0.94); border-bottom: 1px solid rgba(243, 201, 105, 0.24); transition: all 0.2s ease; border-color: rgba(243, 201, 105, 0.24); color: #fdf7e3; }",
        ...
        ".tb-feature-title { font-size: 1.125rem; font-weight: 600; color: #ffe6b3; line-height: 1.3; margin: 0 0 15px; }",
        ...
        ".tb-feature-title-button:focus-visible { outline: 2px solid #059669; outline-offset: 2px; border-radius: 6px; outline-color: rgba(147, 197, 253, 0.65); }",
        ...
        ".tb-feature-description ul { margin: 0 0 0.75rem 1.25rem; padding: 0; }",
        ".tb-feature-description ol { margin: 0 0 0.75rem 1.25rem; padding: 0; }",
        ".tb-feature-description li { margin: 0.25rem 0; }",
        ".tb-feature-description blockquote { margin: 0 0 0.75rem; padding-left: 1rem; border-left: 3px solid rgba(16, 185, 129, 0.6); color: #bfdbfe; border-left-color: rgba(96, 165, 250, 0.5); background: rgba(15, 23, 42, 0.6); }",
        ...
        ".tb-feature-description h1 { margin: 1.25rem 0 0.75rem; font-weight: 600; line-height: 1.2; color: #f8fafc; font-size: 1.6rem; }",
        ".tb-feature-description h2 { margin: 1.25rem 0 0.75rem; font-weight: 600; line-height: 1.2; color: #f8fafc; font-size: 1.45rem; }",
        ".tb-feature-description h3 { margin: 1.25rem 0 0.75rem; font-weight: 600; line-height: 1.2; color: #f8fafc; font-size: 1.3rem; }",
        ".tb-feature-description h4 { margin: 1.25rem 0 0.75rem; font-weight: 600; line-height: 1.2; color: #f8fafc; font-size: 1.15rem; }",
        ".tb-feature-description h5 { margin: 1.25rem 0 0.75rem; font-weight: 600; line-height: 1.2; color: #f8fafc; font-size: 1.05rem; }",
        ".tb-feature-description h6 { margin: 1.25rem 0 0.75rem; font-weight: 600; line-height: 1.2; color: #a5b4fc; font-size: 0.95rem; }",
        ".tb-feature-description h1:first-child { margin-top: 0; }",
        ".tb-feature-description h2:first-child { margin-top: 0; }",
        ".tb-feature-description h3:first-child { margin-top: 0; }",
        ".tb-feature-description h4:first-child { margin-top: 0; }",
        ".tb-feature-description h5:first-child { margin-top: 0; }",
        ".tb-feature-description h6:first-child { margin-top: 0; }",
        ...
        ".tb-feature-meta { display: flex; flex-wrap: wrap; align-items: center; gap: 0.5rem; font-size: 0.875rem; color: #d8cbb3; }",
        ...
        ".tb-vote { display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 2px; min-width: 56px; height: 56px; padding: 0.5rem 1rem; background: rgba(15, 23, 42, 0.35); border: 2px solid rgba(148, 163, 184, 0.35); border-radius: 8px; color: #cbd5f5; font-weight: 600; cursor: pointer; flex-shrink: 0; transition: all 0.2s ease; border-color: rgba(148, 163, 184, 0.35); }",
        ...
        ".tb-loading { display: flex; align-items: center; justify-content: center; gap: 0.75rem; padding: 3rem 1rem; color: #d8cbb3; font-weight: 600; background: rgba(5, 150, 105, 0.05); }",
        ...
        ".tb-empty { padding: 3rem 2rem; text-align: center; color: #94a3b8; background: #0e2630; font-weight: 500; }",
        ".tb-auth-card { background: rgba(14, 38, 48, 0.95); border-radius: 12px; padding: 1.5rem; border: 1px solid rgba(243, 201, 105, 0.28); display: flex; flex-direction: column; gap: 1rem; color: #fdf7e3; }",
        ".tb-auth-card-compact { gap: 0.75rem; }",
        ".tb-auth-tabs { display: inline-flex; background: #193d4c; border-radius: 999px; padding: 0.25rem; gap: 0.25rem; align-self: center; }",
        ".tb-tab { border: none; border-radius: 999px; padding: 0.5rem 1rem; font-size: 0.875rem; font-weight: 500; background: transparent; color: #d8cbb3; cursor: pointer; transition: all 0.2s ease; }",
        ".tb-tab-active { background: rgba(243, 201, 105, 0.18); }",
        ".tb-helper { font-size: 0.875rem; color: #d8cbb3; margin: 0; }",
        ...
        ".tb-label { font-size: 0.875rem; font-weight: 500; color: #d8cbb3; }",
        ".tb-input { border-radius: 8px; border: 2px solid rgba(243, 201, 105, 0.28); padding: 1rem; font-size: 1rem; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; color: #fdf7e3; transition: all 0.2s ease; background: rgba(11, 31, 38, 0.85); border-color: rgba(243, 201, 105, 0.28); }",
        ".tb-input:focus { border-color: rgba(243, 201, 105, 0.55); outline: none; box-shadow: 0 0 0 3px rgba(243, 201, 105, 0.2); }",
        ".tb-textarea { border-radius: 8px; border: 2px solid rgba(243, 201, 105, 0.28); padding: 1rem; font-size: 1rem; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; color: #fdf7e3; transition: all 0.2s ease; resize: vertical; min-height: 120px; background: rgba(11, 31, 38, 0.85); border-color: rgba(243, 201, 105, 0.28); }",
        ".tb-textarea:focus { border-color: rgba(243, 201, 105, 0.55); outline: none; box-shadow: 0 0 0 3px rgba(243, 201, 105, 0.2); }",
        ".tb-submit { border-radius: 8px; padding: 0.5rem 1rem; font-size: 0.875rem; font-weight: 500; background: #f3c969; color: #0b161b; border: 2px solid #dba53c; cursor: pointer; transition: all 0.2s ease; min-height: 46px; }",
        ".tb-submit:hover { background: #ffe1a3; border-color: #f3c969; box-shadow: 0 1px 2px rgba(243, 201, 105, 0.4); }",
        ...
        ".tb-user-email { font-size: 0.875rem; color: #94a3b8; }",
        ".tb-user-actions { display: inline-flex; gap: 0.75rem; align-items: center; }",
        ".tb-footer { display: flex; align-items: center; justify-content: space-between; gap: 1rem; padding: 1rem 2rem; border-top: 2px solid rgba(243, 201, 105, 0.28); flex-shrink: 0; background: rgba(14, 38, 48, 0.95); border-color: rgba(243, 201, 105, 0.28); color: #fdf7e3; }",
        ...
        ".tb-footer-email { font-size: 0.875rem; color: #d8cbb3; }",
        ...
        ".tb-toast { min-width: 300px; background: #d8cbb3; color: #ffffff; padding: 1rem 1.5rem; border-radius: 8px; box-shadow: 0 14px 40px rgba(2, 10, 28, 0.55); font-weight: 500; font-size: 0.875rem; opacity: 0; transform: translateY(20px); transition: all 0.2s; pointer-events: auto; animation: tb-toast-in 0.2s forwards; }",
        ...
        ".tb-feature-meta span { color: #94a3b8; }",
        ".tb-feature-meta time { color: #94a3b8; }",
